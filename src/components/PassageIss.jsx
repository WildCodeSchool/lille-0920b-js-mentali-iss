  ...
  render() {
    ...
    return (
      ...
      >
        <ImgHeadContainer>
          <ImageSecondHeader
            src="/photos/headStar.jpg"
            alt="Beautifool evening picture"
          />
          <HeadTitle>Watch ISS from Home</HeadTitle>
        </ImgHeadContainer>
        <Title1>
          <ImgStarsContainer1>
            <ImageStars1 src="/photos/stars2.jpg" alt="stars" />
        ...
        <Title2>
          <ImgStarsContainer2>
            <ImageStars2 src="/photos/stars2.jpg" alt="stars" />
            <TitleFormDeux>How to observe it ?</TitleFormDeux>
            <Trait2></Trait2>
          </ImgStarsContainer2>
        </Title2>
        <ImgHowObs
        ...
        <Title3>
          <ImgStarsContainer3>
            ...
            <TitleFormTrois>What's the next watching session ?</TitleFormTrois>
            <Trait3></Trait3>
          </ImgStarsContainer3>
        </Title3>
        <PredContainer>
